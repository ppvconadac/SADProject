...
CREATE TABLE `reservation` (
  ...
  CONSTRAINT `fk_Reservation_Room1` FOREIGN KEY (`Room_Room_ID`) REFERENCES `room` (`Room_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2017-12-03 18:00:18
