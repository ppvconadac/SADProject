...
namespace BustosApartment_SAD_
{
    public partial class UCRoomHContent : UserControl
    {
        ...
        public void tablecall2() {
            quer = "SELECT room_number, profile_name, rt_date_start, rt_date_expire FROM room_transaction inner join room inner join ba_db.profile where rt_type = 'Expire' and room_room_id =room_id and Profile_user_ID = user_id";
            call(quer);
        }
        public void dates() {
