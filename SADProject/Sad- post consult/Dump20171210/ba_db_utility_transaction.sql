...
CREATE TABLE `utility_transaction` (
  ...
  KEY `fk_Utility_Transaction_Room1_idx` (`Room_Room_ID`),
  ...
  CONSTRAINT `fk_Utility_Transaction_Room1` FOREIGN KEY (`Room_Room_ID`) REFERENCES `room` (`Room_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2017-12-10 18:15:55
