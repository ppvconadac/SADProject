...
CREATE TABLE `utelect_trans` (
  ...
  `uelect_bill_price` double DEFAULT NULL,
  `uelect_excess` varchar(45) DEFAULT NULL,
  `uelect_rate` double DEFAULT NULL,
  ...
  `uelect_trans_resolved` int(11) DEFAULT NULL,
...
INSERT INTO `utelect_trans` VALUES (1,'2018-3-21',5000,'4599.95',9,'0',NULL,NULL,1);
