...
CREATE TABLE `room_item` (
  ...
  `ritem_archive_date` varchar(45) DEFAULT NULL,
  `ritem_archive_loggedin` varchar(45) DEFAULT NULL,
  `ritem_void_stat` varchar(45) DEFAULT NULL,
...
INSERT INTO `room_item` VALUES (5,'dad','dada','5555',2,'Functional','2018-3-18','1','1'),(6,'dada','dada','555',1,'Functional',NULL,NULL,'0');
...
-- Dump completed on 2018-03-22 19:05:19
